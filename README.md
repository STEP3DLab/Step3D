...
- [ ] Выбор материала (PLA/ABS) в UI
- [ ] Изменение масштаба/габаритов модели пользователем
- [ ] Обработка ошибок при загрузке (размер, формат)
- [ ] Инструкция по развертыванию на GitHub Pages
- [ ] Интеграция с Google Sheets для хранения параметров
